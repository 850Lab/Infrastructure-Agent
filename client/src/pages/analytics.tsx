    ...
    <AppLayout showBackToChip>
      <div className="p-6 space-y-6">
        <div className="flex items-center gap-3 mb-1">
          <span className="text-xs font-mono tracking-wider uppercase" style={{ color: "rgba(45,212,191,0.5)" }}>Bootstrap</span>
        </div>
        <h1 className="text-2xl font-bold glow-text" data-testid="text-page-title">Analytics</h1>
        <p className="text-xs font-mono" style={{ color: "rgba(255,255,255,0.25)" }} data-testid="text-brain-region">Brainstem</p>
